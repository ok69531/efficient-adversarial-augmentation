...
def train(model, loader, optimizer, ratio = 0.3, step_size=0.001, max_pert=0.01, m=3):
    model.train()
...
if __name__ == '__main__':
    ...
    for seed in range(10):
        ...
        val_loader = DataLoader(valid_dataset, batch_size = 64, shuffle = False, num_workers = 0)
        ...
        for epoch in range(1, 30+1):
            ...
            train(model, train_loader, optimizer, ratio = 0.1, step_size=0.001, max_pert = 0.01, m=3)
